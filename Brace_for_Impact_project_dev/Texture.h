...
public:
    ...
    void Texture_Loading (const HDC& mDC , const HINSTANCE& g_hinst ) {
        ...
        idBitmap.emplace ( "B_UI_Alert" , ( HBITMAP ) LoadBitmap ( g_hinst , MAKEINTRESOURCE ( IDB_BM_UI_ALERT ) ) );
        ...
        idBitmap.emplace ( "B_Boss_7_R" , ( HBITMAP ) LoadBitmap ( g_hinst , MAKEINTRESOURCE ( IDB_BM_BOSS_7_R ) ) );
        //스크린 화면 출력
